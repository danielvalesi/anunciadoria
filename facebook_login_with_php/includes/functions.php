...
class Users {
	...
	function __construct(){
		...
		$dbServer = 'mysql.hostinger.com.br'; //Define database server host
		$dbUsername = 'u636977446_an'; //Define database username
		$dbPassword = 'dleite'; //Define database password
		$dbName = 'u636977446_an'; //Define database name
