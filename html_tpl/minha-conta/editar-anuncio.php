       	  ...
       	  <div class="responsive">
          	<div class="form-contato grid_12 last adapt">
               ...
               <div class="grid_12 last responsive">
				...
				<div class="grid_4">
                	<span class="lineform smallControl">
					<input type="text" id="cadastro-valor" placeholder="Valor R$" maxlength="13"<?php if($c->otxt['anuncio_infos']['anuncio_valor']) { ?> value="<?php echo $c->FMoney($c->otxt['anuncio_infos']['anuncio_valor']); ?>"<?php } ?>>
					</span>
                </div>
