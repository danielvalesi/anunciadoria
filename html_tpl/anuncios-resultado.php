...
<section class="pd">
	<div class="container_grid max1200 responsive">
		<div class="grid_12 last txtcenter marg">
			<h2>Encontre<span> a mídia que você procura!</span></h2>
          ...
          <div class="affix">
            <div class="grid_12 last">
              ...
              <div class="com-foto" style="cursor:pointer;" id="anuncios-com-foto">
                <p class="input-perso dinline-block vtop" style="margin-top:4px;"></p>
                <p class="text-pos dinline-block vtop">Apenas anúncios com foto</p>
              </div>
              <div class="area-filtro-valor">
                <p>Arraste para selecionar os valores</p>
                <div id="anuncios-precos"></div>
                <div class="price_label">
                  <span class="fleft from" id="anuncios-precos-de-txt"></span> 
                  <span class="fright to" id="anuncios-precos-ate-txt"></span>
                  <div class="clear"></div>
                </div>
              </div>
              <div class="filtrados">
                <p id="anuncios-valor-aplicado" style="display:none;">
                  <span></span>
                  <a href=""  id="anuncios-valor-aplicado-remover">
                    <img src="img/fechar.png" alt="Excluir" title="Excluir">
                  </a>
                </p>
              </div>
            </div>
